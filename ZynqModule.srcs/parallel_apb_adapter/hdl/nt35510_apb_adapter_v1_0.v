...
module nt35510_apb_adapter_v1_0 (
	...
	output reg         LCD_wr,
	output reg         LCD_rd,
    output reg  [31:0] LCD_addr,
	input  wire [31:0] LCD_data_in,
	output reg  [31:0] LCD_data_out,
	output reg  [31:0] LCD_data_z
);


parameter NT35510_RD_CYCLE	=	(2);
parameter NT35510_WR_CYCLE	=	(2);
			...
			case (state)
				...
				`APH_FSM_SETUP_RS: begin
                    ...
                    if (cyclecount == NT35510_RS_CYCLE) begin
                        cyclecount <= 0;
                        if (APB_pwrite) begin
                            LCD_data_z <= 32'h000000;
                            LCD_data_out <= APB_pwdata[31:0];
                            LCD_wr <= 1'b0;
